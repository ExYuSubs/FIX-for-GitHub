...
//$country
$country = "";
$res = SQL_Query_exec("SELECT name FROM countries WHERE id=".(int)$user["country"]." LIMIT 1");
...
$daysActive = DateDiff($user["added"], time()) / 86400;
...
if ($user["privacy"] != "strong" || ($CURUSER["control_panel"] == "yes") || ($CURUSER["id"] == $user["id"])) {
	...
	<tr class="ttable_head">
		<th width="50%" align="center"><b><?php echo T_("PROFILE"); ?></b></th>
		<th width="50%" align="center"><b><?php echo T_("ADDITIONAL_INFO"); ?></b></th>
	</tr>

	<tr><td><table width="100%" align="center" border="0" cellpadding="0" cellspacing="0"><tr>
		<td class="css" align="left"><?php echo T_("USERNAME"); ?>: </td><td class="css-right"><?php echo htmlspecialchars($user["username"])?></td></tr>
		<td class="css" align="left"><?php echo T_("USERCLASS"); ?>: </td><td class="css-right"><?php echo get_user_class_name($user["class"])?></td></tr>
		<td class="css" align="left"><?php echo T_("TITLE"); ?>: </td><td class="css-right"><i><?php echo format_comment($user["title"] ?? "")?></i></td></tr>
		<td class="css" align="left"><?php echo T_("JOINED"); ?>: </td><td class="css-right"><?php echo htmlspecialchars(utc_to_tz($user["added"]))?></td></tr>
		<td class="css" align="left"><?php echo T_("LAST_VISIT"); ?>: </td><td class="css-right"><?php echo htmlspecialchars(utc_to_tz($user["last_access"]))?></td></tr>
		<td class="css" align="left"><?php echo T_("LAST_SEEN"); ?>: </td><td class="css-right"><?php echo htmlspecialchars($user["page"] ?? "");?></td></tr>
		</td></tr></table></td>

		<td align="left"><table width="100%" align="center" border="0" cellpadding="0" cellspacing="0"><tr>
		<td class="css" align="left"><?php echo T_("AGE"); ?>: </td><td class="css-right"><?php echo htmlspecialchars($user["age"] ?? "")?></td></tr>
		<td class="css" align="left"><?php echo T_("CLIENT"); ?>: </td><td class="css-right"><?php echo htmlspecialchars($user["client"] ?? "")?></td></tr>
		<td class="css" align="left"><?php echo T_("COUNTRY"); ?>: </td><td class="css-right"><?php echo $country?></td></tr>
		<td class="css" align="left"><?php echo T_("DONATED"); ?>:  </td><td class="css-right"><?php echo $site_config['currency_symbol']; ?><?php echo number_format($user["donated"], 2); ?></td></tr> 
		<td class="css" align="left"><?php echo T_("WARNINGS"); ?>: </td><td class="css-right"><?php echo htmlspecialchars($user["warned"])?></td></tr>
		<td class="css" align="left"><?php if ($CURUSER["edit_users"] == "yes"){ echo T_("ACCOUNT_PRIVACY_LVL").": </td><td class='css-right'><b>".T_($user["privacy"])."</b><br />"; }?></td></tr>
		</td></tr></table>
		</td>
	</tr>

	<tr class="ttable_head">
		<th width="50%" align="center"><b><?php echo T_("STATISTICS"); ?></b></th>
		<th width="50%" align="center"><b><?php echo T_("OTHER"); ?></b></th>
	</tr>

	<tr valign="top">
		<td align="left"><table width="100%" align="center" border="0" cellpadding="0" cellspacing="0"><tr>
		<td class="css" align="left"><?php echo T_("UPLOADED"); ?>: </td><td class="css-right"><?php echo mksize($user["uploaded"]); ?></td></tr>
		<td class="css" align="left"><?php echo T_("DOWNLOADED"); ?>: </td><td class="css-right"><?php echo mksize($user["downloaded"]); ?></td></tr>
		<td class="css" align="left"><?php echo T_("RATIO"); ?>: </td><td class="css-right"><?php echo $ratio; ?></td></tr>
		<td class="css" align="left"><?php echo T_("AVG_DAILY_DL"); ?>: </td><td class="css-right"><?php echo mksize($user["downloaded"] / $daysActive); ?></td></tr>
		<td class="css" align="left"><?php echo T_("AVG_DAILY_UL"); ?>: </td><td class="css-right"><?php echo mksize($user["uploaded"] / $daysActive); ?></td></tr>
		<td class="css" align="left"><?php echo T_("TORRENTS_POSTED"); ?>: </td><td class="css-right"><?php echo number_format($numtorrents); ?></td></tr>
		<td class="css" align="left"><?php echo T_("COMMENTS_POSTED"); ?>: </td><td class="css-right"><?php echo number_format($numcomments); ?></td></tr>
        	<td class="css" align="left">Forum Posts: </td><td class="css-right"><?php echo number_format($numforumposts); ?></td></tr>   
		</td></tr></table>
		</td>

		<td align="left"><table width="100%" align="center" border="0" cellpadding="0" cellspacing="0"><tr>
		<td class="css" align="center"><img src="<?php echo $avatar; ?>" alt="" title="<?php echo $user["username"]; ?>" height="135" width="100" /></td></tr>
		<td class="css" align="center"><a href="mailbox.php?compose&amp;id=<?php echo $user["id"]?>" class="buttonS"><?php echo T_("SEND_PM"); ?></a></td></tr>
		<td class="css" align="center"><a href="report.php?user=<?php echo $user["id"]?>" class="buttonS"><?php echo T_("REPORT_MEMBER"); ?></a></td></tr></table>
		</td>
	</tr>
	<?php if ($CURUSER["edit_users"] == "yes") { ?>
	<tr class="ttable_head">
		<th width="50%"><b><?php echo T_("STAFF_ONLY_INFO"); ?></b></th>
		<th width="50%"><b> Other info goes here </b></th>
	</tr>
		...
		<td align="left"><table width="100%" align="center" border="0" cellpadding="0" cellspacing="0"><tr>
			<?php
				if ($user["invited_by"]) {
					...
					echo "<td class='css' align='left'><b>".T_("INVITED_BY")."</b>: </td><td class='css-right'><a href='account-details.php?id=$user[invited_by]'>$row[username]</a></td></tr>";
				}
				echo "<td class='css' align='left'><b>".T_("INVITES")."</b>: </td><td class='css-right'>".number_format($user["invites"])."</td></tr>";
				$invitees = array_reverse(explode(" ", (string)($user["invitees"] ?? "")));
				$rows = [];
				...
				if ($rows)
					echo "<td class='css' align='left'><b>".T_("INVITEES")."</b>: </td><td class='css-right'>".implode(", ", $rows)."</td>";
			?>
</tr></table>
		</td>
	</tr>
	...
	if (mysqli_num_rows($res) == 1) {
		...
		echo"<img src='".htmlspecialchars($arr["image"])."' alt='' /><br />".htmlspecialchars($arr["name"])."<br /><br /><a href='teams-view.php'>[View ".T_("TEAMS")."]</a></td></tr>"; 
	}
	?>
...
if($CURUSER["edit_users"]=="yes"){
	...
	if (isset($_GET["updated"]))
		print("<p align='center' style='color:green'><b>Changes saved.</b></p>\n");

	$avatar = htmlspecialchars($user["avatar"] ?? "", ENT_QUOTES);
	$signature = htmlspecialchars($user["signature"] ?? "", ENT_QUOTES);
	$uploaded = $user["uploaded"];
	$downloaded = $user["downloaded"];
	$enabled = $user["enabled"] == 'yes';
	$warned = $user["warned"] == 'yes';
	$forumbanned = $user["forumbanned"] == 'yes';
	$modcomment = htmlspecialchars($user["modcomment"] ?? '', ENT_QUOTES);

	print("<form method='post' action='admin-modtasks.php'>\n");
	print("<input type='hidden' name='action' value='edituser' />\n");
	print("<input type='hidden' name='userid' value='$id' />\n");
	print("<table border='0' cellspacing='0' cellpadding='3'>\n");
	print("<tr><td>".T_("TITLE").": </td><td align='left'><input type='text' size='67' name='title' value=\"".htmlspecialchars($user["title"] ?? "", ENT_QUOTES)."\" /></td></tr>\n");
	print("<tr><td>".T_("EMAIL")."</td><td align='left'><input type='text' size='67' name='email' value=\"".htmlspecialchars($user["email"] ?? "", ENT_QUOTES)."\" /></td></tr>\n");
	print("<tr><td>".T_("SIGNATURE").": </td><td align='left'><textarea cols='50' rows='10' name='signature'>".$signature."</textarea></td></tr>\n");
	...
	print("<tr><td>".T_("IP_ADDRESS").": </td><td align='left'><input type='text' size='20' name='ip' value=\"".htmlspecialchars($user["ip"] ?? "", ENT_QUOTES)."\" /></td></tr>\n");
	...
	print("<tr><td>".T_("DONATED_US").": </td><td align='left'><input type='text' size='4' name='donated' value='".htmlspecialchars((string)$user["donated"], ENT_QUOTES)."' /></td></tr>\n");
	print("<tr><td>".T_("PASSWORD").": </td><td align='left'><input type='password' size='67' name='password' autocomplete='new-password' value=\"".htmlspecialchars($user["password"] ?? "", ENT_QUOTES)."\" /></td></tr>\n");
...
if($CURUSER["edit_users"]=="yes"){
	...
	if($CURUSER["delete_users"] == "yes"){
		...
		print("<input type='hidden' name='userid' value='$id' />\n");
		print("<input type='hidden' name='username' value='".htmlspecialchars($user["username"], ENT_QUOTES)."' />\n");
